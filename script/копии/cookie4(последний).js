document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateHistoryList() {
        ...
        searchHistory.forEach(query => {
            ...
            li.addEventListener('click', () => {
                ...
                loadData();
                historyList.style.display = 'none'; // Закрыть historyList при клике на элемент
            });
    ...
    window.declineCookies = function () {
        document.cookie = 'cookiesDeclined=true; path=/'; // Сессионные куки
        cookieConsent.style.display = 'none';
...
window.toggleHistory = function () {
    ...
    if (historyList.style.display === 'none' || historyList.style.display === '') {
        historyList.style.width = (inputField.offsetWidth * 0.95) + 'px';
